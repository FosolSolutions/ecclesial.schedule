    ...
    public class DataSource : DataContext
    {
        ...
        protected override void Seed()
        {
            ...
            this.Participants.Add(new Participant[] {
                ...
                new Participant("Debbie Catchpole", "dcatch@telus.net", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
                ...
                new Participant("Andrea Ceron", "1krisely@gmail.com", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
                ...
                new Participant("Jeni Coupar", "jcoupar@shaw.ca", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
                ...
                new Participant("Clive Daniel", "clivedaniel@telus.net", new { Key = "Role", Value = "Brother" }, new { Key = "Role", Value = "Speaker" }, new { Key = "Role", Value = "Presider" })  { Gender = Gender.Male },
                ...
                new Participant("Vikki Ferrie", "vferrie@gmail.com", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
                ...
                new Participant("Mark Little", "mwl@netzero.net", new { Key = "Role", Value = "Brother" }, new { Key = "Role", Value = "Presider" }, new { Key = "Role", Value = "Doorkeeper" })  { Gender = Gender.Male },
                new Participant("Zoe Little", "zhq.6987@gmail.com", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
                ...
                new Participant("Caitlyn Macfarlane", "caitlyndaniel2@gmail.com", new { Key = "Role", Value = "Sister" }, new { Key = "Role", Value = "Pianist" })  { Gender = Gender.Female },
                ...
                new Participant("Trish Myren", "trishmyren@icloud.com", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
                ...
                new Participant("Laura Pengelly", "l_pengelly@hotmail.com", new { Key = "Role", Value = "Sister" })  { Gender = Gender.Female },
